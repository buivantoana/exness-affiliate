    ...
    <Box
      sx={{
        ...
        "&::before": {
          ...
          height: 600,
          background:
            "radial-gradient(circle,rgba(255,222,2,.045) 0%,transparent 65%)",
          pointerEvents: "none",
        },
      }}>
      {/* Logo */}
      ...
      <Stack
        ...
        <Button
          ...
          sx={{
            ...
            textTransform: "none",
            borderRadius: "10px",
            "&:hover": { background: T.yellow2, transform: "translateY(-1px)" },
            transition: "all .2s",
          }}>
          {t("notFound.cta.home")}
        </Button>
        <Button
          ...
          sx={{
            ...
            textTransform: "none",
            borderRadius: "10px",
            "&:hover": { borderColor: "rgba(255,255,255,.4)", color: T.white },
            transition: "all .2s",
          }}>
